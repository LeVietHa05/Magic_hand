...
/**
  ...
  gui thanh cong nhip tim, nhiet do, oxy, web hien thi thanh cong
...
void loop()
{
  ...
  if (millis() - tsLastReport > REPORTING_PERIOD_MS) {
    ...
    GuiDuLieu(nhiptim, nhietdo, oxy, lng, lat);
  }
...
void GuiDuLieu (float nhiptim, float nhietdo, float oxy, float lng, float lat) {
